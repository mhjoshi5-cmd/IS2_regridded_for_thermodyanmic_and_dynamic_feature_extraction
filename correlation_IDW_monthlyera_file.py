...
print(f"🌡️ Mean Air Temperature at IS2 Points (°K): {mean_t2m:.2f}")
print(f"🌬️ Mean U10 at IS2 Points: {mean_u10:.2f} m/s")
print(f"🌬️ Mean V10 at IS2 Points: {mean_v10:.2f} m/s")
